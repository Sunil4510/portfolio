  ...
  <div className="flex flex-col">  
    <div className="flex m-14 sm:flex-col md:flex-col lg:flex-row">
        ...
        <div className="right flex flex-col space-y-10">
            ...
            <a className="font-bold text-xl ml-10 sm:ml-0 text-current" href="./Sunil.pdf" target="_blank"><button className="font-Hahmlet font-bold sm:mt-6 border-2 p-2 border-orange-400 shadow-xl shadow-black rounded-lg hover:bg-orange-400 hover:text-black transition ease-in-out delay-200 duration-150 hover:scale-125">See My Resume</button></a>
        </div>    
    </div>
